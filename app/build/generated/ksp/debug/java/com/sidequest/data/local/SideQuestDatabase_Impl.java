  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(4) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `buckets` (`id` TEXT NOT NULL, `accountId` TEXT NOT NULL, `name` TEXT NOT NULL, `notStartedColor` TEXT NOT NULL, `inProgressColor` TEXT NOT NULL, `completedColor` TEXT NOT NULL, `updatedAt` INTEGER NOT NULL, `version` INTEGER NOT NULL, `deleted` INTEGER NOT NULL, `dirty` INTEGER NOT NULL, PRIMARY KEY(`id`))");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'e92af6ab05d2bd73b92142ef46fc0334')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsBuckets = new HashMap<String, TableInfo.Column>(10);
    ...
    }, "e92af6ab05d2bd73b92142ef46fc0334", "3cc02d22cbe34d424ca2a66520225c32");
