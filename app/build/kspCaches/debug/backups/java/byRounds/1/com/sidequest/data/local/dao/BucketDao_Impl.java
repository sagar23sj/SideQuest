  ...
  public BucketDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfBucketEntity = new EntityInsertionAdapter<BucketEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `buckets` (`id`,`accountId`,`name`,`notStartedColor`,`inProgressColor`,`completedColor`,`imageRef`,`position`,`updatedAt`,`version`,`deleted`,`dirty`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(9, _tmpSync.getUpdatedAt());
        statement.bindLong(10, _tmpSync.getVersion());
    ...
    this.__updateAdapterOfBucketEntity = new EntityDeletionOrUpdateAdapter<BucketEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `buckets` SET `id` = ?,`accountId` = ?,`name` = ?,`notStartedColor` = ?,`inProgressColor` = ?,`completedColor` = ?,`imageRef` = ?,`position` = ?,`updatedAt` = ?,`version` = ?,`deleted` = ?,`dirty` = ? WHERE `id` = ?";
      }
    ...
    this.__upsertionAdapterOfBucketEntity = new EntityUpsertionAdapter<BucketEntity>(new EntityInsertionAdapter<BucketEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "INSERT INTO `buckets` (`id`,`accountId`,`name`,`notStartedColor`,`inProgressColor`,`completedColor`,`imageRef`,`position`,`updatedAt`,`version`,`deleted`,`dirty`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE `buckets` SET `id` = ?,`accountId` = ?,`name` = ?,`notStartedColor` = ?,`inProgressColor` = ?,`completedColor` = ?,`imageRef` = ?,`position` = ?,`updatedAt` = ?,`version` = ?,`deleted` = ?,`dirty` = ? WHERE `id` = ?";
      }
      ...
      public List<BucketEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new BucketEntity(_tmpId,_tmpAccountId,_tmpName,_tmpNotStartedColor,_tmpInProgressColor,_tmpCompletedColor,_tmpImageRef,_tmpPosition,_tmpSync);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public BucketEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmpDirty = _tmp_1 != 0;
            _tmpSync = new SyncMeta(_tmpUpdatedAt,_tmpVersion,_tmpDeleted,_tmpDirty);
            _result = new BucketEntity(_tmpId,_tmpAccountId,_tmpName,_tmpNotStartedColor,_tmpInProgressColor,_tmpCompletedColor,_tmpImageRef,_tmpPosition,_tmpSync);
          } else {
            _result = null;
          }
          return _result;
