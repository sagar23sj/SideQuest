 ...
 * (the `design/stitch` HTML Tailwind configs). It is a Material 3 Expressive
 ...
 * roles in [com.sidequest.ui.theme.SideQuestTheme].
 */
 ...
 * the game screens read clearly. See [com.sidequest.ui.theme.GameColors].
 */
