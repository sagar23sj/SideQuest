...
abstract class AuthModule {
    ...
    companion object {
        ...
        /**
         * Backend API base URL, sourced from [BuildConfig.API_BASE_URL] so debug
         * builds hit the local backend (`http://10.0.2.2:8080/` from the
         * emulator) while release builds use the deployed endpoint.
         */
