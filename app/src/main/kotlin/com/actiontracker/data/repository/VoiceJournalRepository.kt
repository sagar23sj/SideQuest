...
import com.actiontracker.domain.transcription.TranscriptionOutcome
import com.actiontracker.domain.transcription.TranscriptionResult
import com.actiontracker.domain.voice.ConfirmedExtraction
import com.actiontracker.domain.voice.ExtractionConfirmationResult
import com.actiontracker.domain.voice.VoiceActionExtraction
...
class VoiceJournalRepository(
     ...
     * [com.actiontracker.domain.model.ActionItem] (status `NOT_STARTED`) is built
