...
abstract class LlmModule {
    ...
    companion object {
        ...
        /**
         * Placeholder base URL for the backend LLM Proxy. Replaced with the real
         * deployed endpoint when the backend lands in Milestone E.
         */
        const val LLM_PROXY_BASE_URL: String = "https://api.actiontracker.invalid/"
