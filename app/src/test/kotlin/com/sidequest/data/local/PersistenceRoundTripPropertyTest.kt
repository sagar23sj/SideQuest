 ...
 * [SideQuestDatabase] connection against the same on-disk database file:
...
class PersistenceRoundTripPropertyTest {
    ...
    private val openDatabases = mutableListOf<SideQuestDatabase>()
     ...
     */
    private fun openDatabase(dbName: String): SideQuestDatabase {
